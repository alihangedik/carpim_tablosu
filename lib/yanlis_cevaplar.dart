...
class YanlisSorularProvider extends ChangeNotifier {
  ...
  Future<void> loadYanlisSorularFromPrefs() async {
    ...
    List<String>? jsonList =
        prefs.getStringList('yanlisSorular'); // Liste olarak al

    if (jsonList != null) {
      try {
        _yanlisSorular = jsonList
            .map((item) =>
                json.decode(item) as Map<String, dynamic>) // JSON parse et
            .toList();
        notifyListeners();
      } catch (e) {
  ...
  Future<void> saveYanlisSorularToPrefs() async {
    ...
    List<String> jsonList =
        _yanlisSorular.map((item) => json.encode(item)).toList();
...
class _YanlisSorularTabViewState extends State<YanlisSorularTabView>
  ...
  void initState() {
    ...
    setState(() {
      Provider.of<YanlisSorularProvider>(context, listen: false)
          .loadYanlisSorularFromPrefs();
      Provider.of<YanlisSorularProvider>(context, listen: false)
          .saveYanlisSorularToPrefs();
    });
  }
            ...
            Navigator.pushAndRemoveUntil(
                ...
                MaterialPageRoute(
                    builder: (context) => Mainmenu(
                          yanlisSorular: Provider.of<YanlisSorularProvider>(
                                  context,
                                  listen: false)
                              ._yanlisSorular,
                        )),
